<section id="section-exp" class="page-section exp wave blue-bg">
    ...
    <div class="section dark parallax nobottommargin" style="padding: 80px 0; height: 300px; background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/parallax/alianzas.jpg');" data-stellar-background-ratio="0.2">
